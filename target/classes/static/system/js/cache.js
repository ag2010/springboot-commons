...
//    }
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['查看'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">公告消息内容</span></p></div>',
    ...
    $(".lockcms").on("click",function(){
    		var uuname=$(this).attr("value");
        window.sessionStorage.setItem("lockcms",true);
        window.sessionStorage.setItem("uname",uuname);
        lockPage(uuname);
    })
    // 判断是否显示锁屏
    if(window.sessionStorage.getItem("lockcms") == "true"){
    		var uuname=window.sessionStorage.getItem("uname");
        lockPage(uuname);
    }
    // 解锁
            ...
            content :  '<div class="functionSrtting_box">'+
                            '<form class="layui-form">'+
                                ...
                                '<div class="layui-form-item skinBtn">'+
                                    '<a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit="" lay-filter="settingSuccess">保存</a>'+
